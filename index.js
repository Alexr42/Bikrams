...
let postI = 0;
let postJ = 0;
for (let iteracion = 1; iteracion <= 11; iteracion++) {
  postI += postJ++;
}
...
let booleanoMix1 = (booleano1 && ((TAU / 2) === Math.PI)) || (variableValorNumerico >= MiNumeroFav);
